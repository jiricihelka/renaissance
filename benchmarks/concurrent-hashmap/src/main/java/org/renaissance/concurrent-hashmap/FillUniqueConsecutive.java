...
@Configuration(name = "serial-16M-prealloc", settings = {"thread_count = 1", "total_items = 16000000", "prealloc = true"})
...
@Configuration(name = "2T-16M-prealloc", settings = {"thread_count = 2", "total_items = 16000000", "prealloc = true"})
@Configuration(name = "4T-16M-prealloc", settings = {"thread_count = 4", "total_items = 16000000", "prealloc = true"})
@Configuration(name = "8T-16M-prealloc", settings = {"thread_count = 8", "total_items = 16000000", "prealloc = true"})
@Configuration(name = "16T-16M-prealloc", settings = {"thread_count = 16", "total_items = 16000000", "prealloc = true"})
@Configuration(name = "32T-16M-prealloc", settings = {"thread_count = 32", "total_items = 16000000", "prealloc = true"})
@Configuration(name = "64T-16M-prealloc", settings = {"thread_count = 64", "total_items = 16000000", "prealloc = true"})
